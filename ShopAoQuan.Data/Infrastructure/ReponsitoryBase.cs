...
namespace ShopAoQuan.Data.Infrastructure
{
    public abstract class RepositoryBase<T> : IRepository<T> where T : class
    {
        ...
        private ShopQuanAoDbContext dataContext;
        private readonly IDbSet<T> dbSet;

        protected IDbFactoty DbFactory
        {
            get;
            private set;
        }

        protected ShopQuanAoDbContext DbContext
        {
        ...
        protected RepositoryBase(IDbFactoty dbFactory)
        {
            DbFactory = dbFactory;
